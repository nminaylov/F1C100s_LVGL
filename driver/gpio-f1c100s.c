...
const gpio_port_t GPIO_PA = { .virt = 0x01c20800, .base = 0, .ngpio = 4, .oirq = 0 };

const gpio_port_t GPIO_PB = { .virt = 0x01c20824, .base = 0, .ngpio = 4, .oirq = 0 };

const gpio_port_t GPIO_PC = { .virt = 0x01c20848, .base = 0, .ngpio = 4, .oirq = 0 };

const gpio_port_t GPIO_PD = { .virt = 0x01c2086c, .base = 0, .ngpio = 22, .oirq = 0 };

const gpio_port_t GPIO_PE = { .virt = 0x01c20890, .base = 0, .ngpio = 13, .oirq = 0 };

const gpio_port_t GPIO_PF = { .virt = 0x01c208b4, .base = 0, .ngpio = 6, .oirq = 0 };
